...
ai_resume_prompt = """
You are an expert resume writer. Create a customized, professional resume for the following job application.
Use the job description, company information, and user's background to tailor the resume.
...
3. Emphasize skills mentioned in the job description
4. Keep the format professional and easy to read
5. Include all relevant sections: Summary, Experience, Skills, Projects, Education
6. Make the resume ATS-friendly with clear section headers
7. Focus on achievements and impact rather than just responsibilities

Return a well-structured resume with clear sections and professional formatting.
"""

ai_cover_letter_prompt = """
You are an expert career assistant. Write a professional, personalized cover letter for the following job application. 
- Use the job description and company information provided.
- Highlight the candidate's relevant skills and experience.
- Make the letter concise, engaging, and tailored to the job.
