...
# Proxy configuration for additional anonymity (Optional)
use_proxy = False                   # True or False, Note: True or False are case-sensitive
proxy_server = ""                   # Format: "ip:port" or "username:password@ip:port" for authenticated proxies
